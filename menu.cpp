...
int main() {
    ...
    if ((ingrediente_1 == "arroz" || ingrediente_1 == "feijao" || ingrediente_1 == "batata") || (ingrediente_2 == "batata" || ingrediente_1 == "arroz" || ingrediente_1 == "feijao")) {
    ...
    if ((ingrediente_1 == "carapau" && ingrediente_2 == "arroz") || (ingrediente_1 == "arroz" && ingrediente_2 == "carapau")) {
